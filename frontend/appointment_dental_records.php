...
$patient_id =  $userDetails->patient_id;
 ...
 $stmt = $db->prepare("SELECT COUNT(appointment_id) FROM appointments WHERE  patient_id =:patient_id AND status='done' ");
...
$textline1 = " Appointment Records (<b>$rows</b>)";
...
$stmt3 = $db->prepare("SELECT * FROM appointments WHERE  patient_id =:patient_id AND status='done' ORDER BY appointment_id DESC $limit");
...
<a href="home.php"><button name= 'back'  >back</button></a> -->
</body>
</html>