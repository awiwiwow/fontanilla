...
<head>
 ...
 <title>Fontanilla-Halili Dental Clinic</title>
    <link rel="shortcut icon" href="image/FontanillaIcon.png" /><title>Dental Clinic</title>
</head>
<body>
          ...
          <div class="container">
            ...
            <div id="default" class="tabcontent">
              ...
              <div class="progress-bar-appoint">
                ...
                <div class="step2">
                  <div class="circle2 activecircle">
                    <p>2</p>
                  </div>
                  <h4>Set Date & Time <span>▶</span></h4>
                </div>
                <div class="step3">
                  <div class="circle3 notactivecircle">
                    <p>3</p>
                  </div>
                  <h4>Almost Done</h4>
                </div>
           ...
           <?php require 'appointment_set_b1.php'; ?>
      ...
      <div class="Footer">
        ...
        <div class="footer-1">
          <div class="left-footer">
            ...
            <a href="#0"> <p>Binakayan branch : TIRONA ROAD, BINAKAYAN  </p> </a>
            <a href="#0"> <p>Langkaan branch: #45 GOVERNOR'S DRIVE </p> </a>
            <a href="#0"> <p>Dasma-Bayan branch: 2ND FLOOR CM PLAZA BUILDING </p> </a>
          </div>
