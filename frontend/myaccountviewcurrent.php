  ...
  <div class="grid-container">
    ...
    <div class="Header-title">
      ...
      <ul>
        ...
        <li><a href="#0"><button class="button1 active">Current Appointment</button></a></li>
        ...
        <div class="account-card2">
          ...
          <div class="container">
            ...
            <div id="default" class="tabcontent">
              ...
              <?php require'appointment_current.php'; ?>
              
                <?php

          $db = getDB();

          $checkapp = $db->prepare("SELECT patient_id FROM appointments WHERE  patient_id=:patient_id AND status='pending' OR  patient_id=:patient_id AND status='confirmed'  ");
          $checkapp->bindParam("patient_id", $patient_id,PDO::PARAM_STR);
          $checkapp->execute();

          $count=$checkapp->rowCount(); //  number of rows affected by the condition
          if($count<1){ // if there is none... display 
