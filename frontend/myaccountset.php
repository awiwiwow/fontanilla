...
<body>
  ...
  <div class="grid-container">
    ...
    <div class="Header-title">
      ...
      <ul>
        <li><a href="#0"><button class="button1 active">Set Appointment</button></a></li>
          ...
          <div class="container">
            ...
            <div id="default" class="tabcontent">
              ...
              <div class="progress-bar-appoint">
                <div class="step1">
                  <div class="circle1 activecircle">
                    <p>1</p>
                  </div>
              ...
              <a href="myaccountbranch1.php"> <div class="br1">
              <h2>Branch 1 : Dasma-Bayan</h2>
              <h3>2nd Floor CM Plaza Building, Dasmarinas, Cavite</h3>
              </div>
            </a>

              <a href="myaccountbranch2.php"> <div class="br2">
                <h2>Branch 2 : Binakayan</h2>
                <h3>Tirona Road,Binakayan Kawit, Cavite</h3>
              </div>
             </a>

             <a href="myaccountbranch3.php"> <div class="br3">
                <h2>Branch 3 : Langkaan</h2>
