...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    if( isset($_SESSION['regmessage']) AND !empty($_SESSION['regmessage']) ):
        echo $_SESSION['regmessage'] .'You may now <a href="reglogin.php">Log in</a>';
    ...
    <a href="index.php"><button style="width:300px;height:30px;color:white;font-size:20px;background:#147bd6;margin:40px 0 0 30px;cursor:pointer;" class="button button-block"/>Login</button></a>
</div>
    </div>
    <div class="footer">
      <div class="left">
