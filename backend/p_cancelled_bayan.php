...
<div class="grid-container">
  ...
  <div class="main-container">
    ...
    <a href="menulist1_bayan.php"><button style="position:absolute;right:30px;width:100px;height:40px;font-size:20px;">Back</button></a>

    <div id="Cancel" class="tabcontent">
     <?php require'app_cancelled_bayan.php';?>
    </div>
