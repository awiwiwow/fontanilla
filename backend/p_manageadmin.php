...
<div class="grid-container">
    ...
    <div class="sidebar">
      ...
      <ul>
        <li> <a href="index.html" class="tablink fas fa-desktop"><span>Dashboard</span> </a> </li>

        <li> <a href="menulist1.html" class="fas fa-clipboard-check tablink"> <span>Appointment</span> </a> </li>

        <li> <a href="menulist2.html" class="fas fa-clipboard-check tablink"> <span>Inquiries</span> </a> </li>

        <li> <a href="menulist3.html" class="far fa-user tablink"> <span>Settings</span> </a> </li>

        <li> <a href="menulist4.html" class="fas fa-th-large tablink"> <span>CMS</span> </a> </li>

        <li> <a href="menulist5.html" class="fas fa-file-export tablink"> <span>Reports</span> </a> </li>
  ...
  <div class="main-container">
    ...
    <div id="ManageAdmin" class="tabcontent">
      <h3>About</h3>
