...
<div class="grid-container">
    ...
    <div class="sidebar">
      ...
      <ul>
        ...
        <li id="actee"> <a href="menulist1_bayan.php" class="fas fa-calendar-check tablink"> <span>Appointment</span> </a> </li>
  ...
  <div class="main-container">
    <header>
      ...
      <div class="tabcontent-based">
       <a href="menulist1_bayan.php"><button style="position:absolute;right:30px;width:100px;height:40px;font-size:20px;margin-bottom:30px;">Back</button></a>
    <div id="Pending" class="tabcontent">
     <?php require'appointment_pending.php';?>
    </div>
