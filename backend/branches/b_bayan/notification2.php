...
<?php
                     	...
                     	$sql = "SELECT * FROM appointments WHERE status='active' AND branch='Dasma-Bayan' ";
                    	...
                    	$sql2 = "SELECT * FROM appointments WHERE status='pending' AND branch='Dasma-Bayan' ";

                    	$conn->query($sql2);
                    	$pending=mysqli_affected_rows($conn);


                     	$sql3 = "SELECT * FROM appointments WHERE status='done'  AND branch='Dasma-Bayan' ";
                    	...
                    	$done=mysqli_affected_rows($conn);
                     	...
                     	$sql4 = "SELECT * FROM appointments WHERE status='cancelled'  AND branch='Dasma-Bayan' ";
				...
				// 		echo date("d-F-Y");
                    	...
                    	$sql6 = "SELECT * FROM appointments WHERE sched_date = '$datetoday' AND status='active'  AND branch='Dasma-Bayan' ";
