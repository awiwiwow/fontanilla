...
<div class="grid-container">
    ...
    <div class="sidebar">
      ...
      <ul>
        ...
        <li> <a href="menulist1_langkaan.php" class="fas fa-calendar-check tablink"> <span>Appointment</span> </a> </li>
