...
<?php
                     	...
                     	$sql = "SELECT * FROM appointments WHERE status='active' AND branch='Langkaan'";
                    	...
                    	$sql2 = "SELECT * FROM appointments WHERE status='pending'  AND branch='Langkaan' ";

                    	$conn->query($sql2);
                    	$pending=mysqli_affected_rows($conn);


                     	$sql3 = "SELECT * FROM appointments WHERE status='done'  AND branch='Langkaan' ";
                    	...
                    	$done=mysqli_affected_rows($conn);
                     	...
                     	$sql4 = "SELECT * FROM appointments WHERE status='cancelled'  AND branch='Langkaan' ";
				...
				// 		echo date("d-F-Y");
                    	...
                    	$sql6 = "SELECT * FROM appointments WHERE sched_date = '$datetoday' AND status='active'  AND branch='Langkaan' ";
