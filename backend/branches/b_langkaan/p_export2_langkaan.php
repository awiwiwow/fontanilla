...
<div class="grid-container">
    ...
    <div class="sidebar">
      ...
      <ul>
        <li> <a href="index4.php" class="fas fa-desktop"><span>Dashboard</span> </a> </li>

        <li> <a href="menulist1_langkaan.php" class="fas fa-calendar-check"> <span>Appointment</span> </a> </li>


        <li  id="actee"> <a href="menulist5_langkaan.php" class="fas fa-file-export"> <span>Reports</span> </a> </li>
  ...
  <div class="main-container">
    ...
    <div id="Export" class="tabcontent">
         <?php require'patient_rec_langkaan.php';?>
    </div>
  </div>
