...
<div class="grid-container">
    ...
    <div class="sidebar">
      ...
      <ul>
        ...
        <li id="actee"> <a href="menulist1_binakayan.php" class="fas fa-calendar-check tablink"> <span>Appointment</span> </a> </li>


        <li> <a href="menulist5_binakayan.php" class="fas fa-file-export tablink"> <span>Reports</span> </a> </li>
  ...
  <div class="main-container">
    <header>
      ...
      <div class="tabcontent-based">
       <a href="menulist1_binakayan.php"><button style="position:absolute;right:30px;width:100px;height:40px;font-size:20px;margin-bottom:30px;">Back</button></a>
    <div id="Pending" class="tabcontent">
     <?php require'app_pending_binakayan.php';?>
    </div>
