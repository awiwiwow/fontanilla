...
<div class="grid-container">
    ...
    <div class="sidebar">
      ...
      <ul>
        ...
        <li> <a href="menulist5_binakayan.php" class="fas fa-file-export"> <span>Reports</span> </a> </li>
  ...
  <div class="tabcontent-based">
    ...
    <div id="Home" class="tabcontent">
      ...
      <a href="p_pending_binakayan.php">
