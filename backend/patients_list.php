...
<body>
        <div class="container" style="width:100%;float:left;margin:0px;padding:0px;margin-top:30px;">
          <br>

            <table id="patientslist" class="display nowrap" cellspacing="0">
                <thead>
                    <tr>
                ...
                <tbody>
                    <?php
                     $sql = "SELECT * FROM patients WHERE status ='good' ";
        ...
        <?php
                        ...
                        if(isset($_POST['accountstatusUpdate'])){
                            ...
                            if ($conn->query($sql) === TRUE) {
                                ...
                                echo '<script>window.location.href="p_patient_list.php"</script>';
                            } else {
