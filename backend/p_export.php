...
<div class="grid-container">
    ...
    <div class="sidebar">
      ...
      <ul>
        <li> <a href="index.php" class="fas fa-desktop"><span>Dashboard</span> </a> </li>
        ...
        <li  id="actee"> <a href="menulist5.php" class="fas fa-file-export"> <span>Reports</span> </a> </li>
  ...
  <div class="main-container">
    ...
    <div id="Export" class="tabcontent">
         <?php require'appointment_records.php';?>
         <?php require'sendcopy.php';?>
    </div>
  </div>
