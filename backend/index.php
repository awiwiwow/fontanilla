...
<div class="grid-container">
    ...
    <div class="sidebar">
      ...
      <ul>
        ...
        <li > <a href="menulist1.php" class="fas fa-calendar-check"> <span>Appointment</span> </a> </li>

        <li> <a href="menulist2.php" class="fas fa-info-circle"> <span>Inquiries</span> </a> </li>

        <li> <a href="menulist3.php" class="fas fa-users-cog"> <span>Settings</span> </a> </li>

        <li> <a href="menulist4.php" class="fas fa-laptop"> <span>CMS</span> </a> </li>

        <li> <a href="menulist5.php" class="fas fa-file-export"> <span>Reports</span> </a> </li>
  ...
  <div class="tabcontent-based">
    ...
    <div id="Home" class="tabcontent">
      ...
      <a href="p_activeappointments.php">
      ...
      <a href="p_pendingappointments.php">
      ...
      <a href="p_inquirylist.php">
      <div class="home-middle-content2">
        <div class="icun4">
          <i class="far fa-address-book"></i>
        </div>
        <div class="tixt">
        <h1><?php echo $inquiries?></h1>
         <h3>New inquiries</h3>
        </div>
      </div>
      </a>
