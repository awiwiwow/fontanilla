...
<div class="grid-container">
  ...
  <div class="sidebar">
    ...
    <ul>
      ...
      <li id="actee"> <a href="#" class="fas fa-users-cog tablink"> <span>Settings</span> </a> </li>
      ...
      <div class="home-left-content2-menu">
        ...
        <div class="txxt" style="width:300px;">
          <h3>Patients List</h3>
            ...
            <a href="p_patient_blacklist.php">
      <div class="home-left-content2-menu">
        <div class="icun3">
          <i class="fas fa-user-times"></i>
        </div>
        <div class="txxt" style="width:300px;">
          <h3>Patients Blacklist</h3>
        </div>
      </div>
      </a>
      
      
        <a href="p_procedurelist.php">
